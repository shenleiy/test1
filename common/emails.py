...
my_sender = '13456140816@163.com'
my_passwd = 'Aa123456'
my_user = '13456140816@163.com'
...
def mail():
    try:
        ...
        xlsxpart = MIMEApplication(
            open('D:\\Python\\PyCharm Community Edition 2019.2.3\\A+6.0 Interface Api\\report\\reporthtml\\index.html',
                 'rb').read())
